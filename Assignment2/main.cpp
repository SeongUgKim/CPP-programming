...
int main()
{
	...
	Person* a2 = new Person("b", 2);
	Person* a3 = new Person("c", 3);
	sedanTest.AddPassenger(a1);
	sedanTest.AddPassenger(a2);
	sedanTest.AddPassenger(a3);
	Trailer* t1 = new Trailer(10);
	Trailer* t2 = new Trailer(20);
	sedanTest.RemovePassenger(0);
